...
\cventry
	...
	{Feb. 2019 - Sep. 2019} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			\item {Marktanalyse: Benchmarke verschiedene Chiffre, wie z.B. Filter, Schleusen, Rohrweiche und Zyklon}
			\item {CAQ: Statistiken zu den Reklamationen (Installation und Customer Complaints) folgen und analysieren.}
